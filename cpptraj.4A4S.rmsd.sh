...
symmrmsd ToFirstAll2-21 :2-21&!@H= first out rmsd1.agr mass time 0.00002 xlabel "  " 
symmrmsd ToFirstHairpin10-13 :10-13&!@H= first out rmsd1.agr mass time 0.00002 
symmrmsd ToFirstStem2-9,14-21 :2-9,14-21&!@H= first out rmsd1.agr mass time 0.00002 


symmrmsd ToFirstAll :2-21&!@H= first out rmsd1.dat mass time 0.00002  
symmrmsd ToFirstHairpin :10-13&!@H= first out rmsd1.dat mass time 0.00002 
symmrmsd ToFirstStem :2-9,14-21&!@H= first out rmsd1.dat mass time 0.00002 
