triplet[1]="ACGUUGCUACGUACGAUCUGUAGCUGAUCGUACGUAGCUGAUGCUGCAGCUGACUGGAGCUGAUCGUCGAUCGAUGCAUGCAUGCAUGCGUAGCAGU"
declare -p triplet
...
sed '/TER/,$d' *.pdb > srna.pdb  

cd ../

#tleap -f /home/nkumarachchi2019/dimeric_force_field/Test/all_trimers/xleap.old.in 