...
cat>input<<EOF
parm ../combine2/strip.prmtop.new
trajin ../combine2/combined_md.mdcrd 1 last 1

multidihedral AllTorsions1 alpha beta gamma delta epsilon zeta chin resrange 1-4 out AllTorsions1.dat range360
run
