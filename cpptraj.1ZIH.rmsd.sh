...
symmrmsd ToFirstAll2-11 :2-11&!@H= first out rmsd1.agr mass time 0.00002 xlabel "  " 
symmrmsd ToFirstHairpin5-8 :5-8&!@H= first out rmsd1.agr mass time 0.00002 
symmrmsd ToFirstStem2-4,9-11 :2-4,9-11&!@H= first out rmsd1.agr mass time 0.00002 


symmrmsd ToFirstAll1-2 :2-11&!@H= first out rmsd1.dat mass time 0.00002  xlabel "  "
symmrmsd ToFirstHairpin1-2  :5-8&!@H= first out rmsd1.dat mass time 0.00002 
symmrmsd ToFirstStem1-2 :2-4,9-11&!@H= first out rmsd1.dat mass time 0.00002 
