...
#$#$#$#$#$#$#$#$$ beta1 #$#$#$#$#$#$
	...
	set beta1_definition [atomselect top " (  ( (resname $fiveP) and (type H5T O5' C5' C4') )  )"] ;
	 ...
	 puts "$beta1_four_serial_list 180.00 B  #beta1"  
	 
         puts "$beta1_four_serial_list F" 
...
#$#$#$#$#$#$#$#$$ gamma1 #$#$#$#$#$#$
	...
	puts  "$gamma1_four_serial_list 50.00 B #gamma1"
        puts  "$gamma1_four_serial_list F"
...
puts "$delta1_four_serial_list 82.00 B #delta1"
 puts  "$delta1_four_serial_list F"
...
#$#$#$#$#$#$#$#$$ delta2 #$#$#$#$#$#$
        ...
        set delta2_four_serial_list [$delta2_definition get serial] ;
               ...
               puts  "$delta2_four_serial_list -70.00 B #sideOHup"
               puts  "$delta2_four_serial_list F"
...
#$#$#$#$#$#$#$#$$ epsilon1 #$#$#$#$#$#$
        ...
        set epsilon1_four_serial_list [$epsilon1_definition get serial] ;
                ...
                puts  "$epsilon1_four_serial_list 210.00 B #epsi1"
                puts  "$epsilon1_four_serial_list F"
...
#$#$#$#$#$#$#$#$$ zeta #$#$#$#$#$#$
        ...
        set zeta_four_serial_list [$zeta_definition get serial] ;
                ...
                puts  "$zeta_four_serial_list 290.00 B #zeta1"
                puts  "$zeta_four_serial_list F"
...
if { $fiveP == "RC5" || $fiveP == "RU5" } {
        ...
        set chi_upper_definition [atomselect top "( ((resname $fiveP) and (type O4' C1' N1 C2)) )"] ;
